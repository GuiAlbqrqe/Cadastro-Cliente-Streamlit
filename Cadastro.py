...
with col1:
    ...
    dt_nasc = st.date_input("Data Nascimento", value=None,min_value=date(1900, 1, 1), max_value=date.today(), format="DD/MM/YYYY")
...
with col2:
    ...
    numero_casa = st.text_input("N° e Tipo",placeholder="Digite o Número e Tipo do Endereço",
                            key="numero_casa")
